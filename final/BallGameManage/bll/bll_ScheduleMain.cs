...
namespace Bll
{
	...
	/// T_ScheduleMain
	/// </summary>
	public partial class bll_ScheduleMain
	{
        dal_Help help = new dal_Help();
        private readonly Dal_ScheduleMain dal = new Dal_ScheduleMain();
        public bll_ScheduleMain()
		{}
		#region  BasicMethod
		/// <summary>
		/// 是否存在该记录
        ...
        {
            string tableName = "T_ScheduleMain";
            string fieldKey = "SID";
		...
		/// 获得数据列表
		/// </summary>
		public List<entity_ScheduleMain> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<entity_ScheduleMain> DataTableToList(DataTable dt)
		{
			List<entity_ScheduleMain> modelList = new List<entity_ScheduleMain>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				entity_ScheduleMain model;
