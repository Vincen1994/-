...
namespace Common
{
    public class StringHelp
    {
        ...
        public static string stringInterception(string str)
        {
            int i = str.Length;
            int j = str.IndexOf('.');
            string stt = str.Substring(j, (i - j));
            return stt;
        }
        ...
        {
            str = str.Replace("<", "+shuming");
            str = str.Replace(">", "-shuming");
            str = str.Replace(":", "+maohao");
            str = str.Replace("/", "+xiegang");
            str = str.Replace(" ", "+kongge");
            str = str.Replace("=", "+dengyu");
            str = str.Replace(@"\", "+fanxiegang");
            return str;
        }
        /// <summary>
        /// text转换成HTML
        ...
        public static string updateStr(string date)
        {
            string d = "";

            try
            {
                d = Convert.ToDateTime(date).ToString("yyyy-MM-dd");
            }
            catch (Exception e)
            {
                d = date;
