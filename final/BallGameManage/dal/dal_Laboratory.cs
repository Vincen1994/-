...
namespace DAL
{
	...
	/// 数据访问类:Laboratory
	/// </summary>
	public partial class dal_Laboratory
	{
        public dal_Laboratory()
		{}
		#region  BasicMethod
        ...
        public bool Add(entity_Laboratory model)
		{
			...
			strSql.Append("SID,Name,Code,Expand1,Expand2,Expand3)");
			...
			parameters[3].Value = model.Expand1;
			parameters[4].Value = model.Expand2;
			parameters[5].Value = model.Expand3;
        ...
        public bool Update(entity_Laboratory model)
		{
			...
			parameters[2].Value = model.Expand1;
			parameters[3].Value = model.Expand2;
			parameters[4].Value = model.Expand3;
        ...
        public entity_Laboratory GetModel(string SID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 SID,Name,Code,Expand1,Expand2,Expand3 from Laboratory ");
			strSql.Append(" where SID=@SID ");
			SqlParameter[] parameters = {
					new SqlParameter("@SID", SqlDbType.NVarChar,50)			};
			parameters[0].Value = SID;
		...
		/// 得到一个对象实体
		/// </summary>
        public entity_Laboratory DataRowToModel(DataRow row)
		{
            entity_Laboratory model = new entity_Laboratory();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select SID,Name,Code,Expand1,Expand2,Expand3 ");
