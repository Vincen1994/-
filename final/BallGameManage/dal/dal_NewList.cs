...
namespace Dal
{
	...
	/// 数据访问类:News
	/// </summary>
	public partial class dal_NewList
	{
		#region  BasicMethod
		...
		public bool Add(entity_News model)
		{
			...
			strSql.Append("sid,title,Content,CreateTime,type,CreatePeople)");
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@CreatePeople", SqlDbType.NVarChar,50)};
			parameters[0].Value = model.sid;
			parameters[1].Value = model.title;
			parameters[2].Value = model.Content;
			parameters[3].Value = model.CreateTime;
			parameters[4].Value = model.type;
			parameters[5].Value = model.CreatePeople;
        ...
        public bool Update(entity_News model)
		{
			...
			strSql.Append("CreatePeople=@CreatePeople");
			strSql.Append(" where sid=@sid ");
			SqlParameter[] parameters = {
					new SqlParameter("@title", SqlDbType.NVarChar,500),
					new SqlParameter("@Content", SqlDbType.NVarChar,-1),
			...
			parameters[4].Value = model.CreatePeople;
		...
		public entity_News GetModel(string sid)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 sid,title,Content,CreateTime,type,CreatePeople from News ");
			strSql.Append(" where sid=@sid ");
			SqlParameter[] parameters = {
					new SqlParameter("@sid", SqlDbType.NVarChar,50)			};
			parameters[0].Value = sid;

            entity_News model = new entity_News();
		...
		/// 得到一个对象实体
		/// </summary>
        public entity_News DataRowToModel(DataRow row)
		{
            entity_News model = new entity_News();
			if (row != null)
			{
				...
				if(row["CreatePeople"]!=null)
				{
					model.CreatePeople=row["CreatePeople"].ToString();
				}
			}
			return model;
		}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select sid,title,Content,CreateTime,type,CreatePeople ");
